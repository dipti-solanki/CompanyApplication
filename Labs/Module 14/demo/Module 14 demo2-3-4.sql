...
INSERT INTO dbo.ProductImport (ProductDetails) VALUES ('<Production.Product xmlns="urn:schemas-microsoft-com:sql:SqlRowSet3" ProductID="1" Name="Adjustable Race" ListPrice="0.0000" />');
...
CREATE PRIMARY XML INDEX IX_ProductImport_ProductDetails ON dbo.ProductImport (ProductDetails);

CREATE XML INDEX IX_ProductImport_ProductDetails_Value ON dbo.ProductImport (ProductDetails)
USING XML INDEX IX_ProductImport_ProductDetails FOR VALUE;
...
--without primary clustered index it will not create
